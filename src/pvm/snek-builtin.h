...
static CONST uint8_t snek_builtin_names[] = {
    'a',    'b', 's',   0,    'c',  'h',    'r',      0,   'l', 'e',   'n',
    0,      'm', 'a',   't',  'h',  '.',    's',      'q', 'r', 't',   0,
    'o',    'r', 'd',   0,    'p',  'r',    'i',      'n', 't', 0,     's',
    'y',    's', '.',   's',  't',  'd',    'o',      'u', 't', '.',   'f',
    'l',    'u', 's',   'h',  0,    'F',    'a',      'l', 's', 'e',   0,
    'N',    'o', 'n',   'e',  0,    'T',    'r',      'u', 'e', 0,     '_',
    0,      'e', 'n',   'd',  0,    AND,    'a',      'n', 'd', 0,     BREAK,
    'b',    'r', 'e',   'a',  'k',  0,      CONTINUE, 'c', 'o', 'n',   't',
    'i',    'n', 'u',   'e',  0,    DEF,    'd',      'e', 'f', 0,     DEL,
    'd',    'e', 'l',   0,    ELIF, 'e',    'l',      'i', 'f', 0,     ELSE,
    'e',    'l', 's',   'e',  0,    FOR,    'f',      'o', 'r', 0,     GLOBAL,
    'g',    'l', 'o',   'b',  'a',  'l',    0,        IF,  'i', 'f',   0,
    IMPORT, 'i', 'm',   'p',  'o',  'r',    't',      0,   IN,  'i',   'n',
    0,      IS,  'i',   's',  0,    NOT,    'n',      'o', 't', 0,     OR,
    'o',    'r', 0,     PASS, 'p',  'a',    's',      's', 0,   RANGE, 'r',
    'a',    'n', 'g',   'e',  0,    RETURN, 'r',      'e', 't', 'u',   'r',
    'n',    0,   WHILE, 'w',  'h',  'i',    'l',      'e', 0,
};
...
extern snek_poly_t snek_builtin_abs(snek_poly_t a0);

extern snek_poly_t snek_builtin_chr(snek_poly_t a0);

extern snek_poly_t snek_builtin_len(snek_poly_t a0);

extern snek_poly_t snek_builtin_math_sqrt(snek_poly_t a0);

extern snek_poly_t snek_builtin_ord(snek_poly_t a0);

extern snek_poly_t snek_builtin_print(uint8_t nposition, uint8_t nnamed,
                                      snek_poly_t *args);

extern snek_poly_t snek_builtin_sys_stdout_flush(void);
