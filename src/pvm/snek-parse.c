...
#define VALUE_DEBUG 1

static snek_parse_val_t _value_pop(const char *file, int line) {
  (void)file;
  (void)line;
#ifdef VALUE_DEBUG
...
static bool _value_push(snek_parse_val_t value, const char *file, int line) {
  (void)file;
  (void)line;
...
static bool _value_push_offset(snek_offset_t value, const char *file,
                               int line) {
  (void)file;
  (void)line;
#ifdef VALUE_DEBUG
...
static bool _value_push_bool(bool value, const char *file, int line) {
  (void)file;
  (void)line;
#ifdef VALUE_DEBUG
...
static bool _value_push_indent(uint8_t value, const char *file, int line) {
  (void)file;
  (void)line;
#ifdef VALUE_DEBUG
...
static bool _value_push_op(snek_op_t op, const char *file, int line) {
  (void)file;
  (void)line;
#ifdef VALUE_DEBUG
...
static bool _value_push_id(snek_id_t id, const char *file, int line) {
  (void)file;
  (void)line;
#ifdef VALUE_DEBUG
